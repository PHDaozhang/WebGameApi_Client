<template>
  <div class="app-container" v-loading="listLoading" v-if="GLOBAL.checkPermission(128) || GLOBAL.checkPermission(131)">
    ...
    <!--:showAddBtn="GLOBAL.checkPermission(128) || true"-->
    <search-type-two
      showAddBtn="true"
      :showDateTime="false"
...
export default {
  ...
  data() {
    ...
    if(this.$store.getters.accountInfo === undefined )
    {
      console.log("go this.... accountInfo is undefined");
    }
  ...
  created() {
    ...
    if(this.GLOBAL.checkPermission(131)){
      this.getList();
    }
    // this.getNodeList();
    this.fnGetConfig();
